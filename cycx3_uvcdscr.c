...
const uint8_t CyCx3USBSSConfigDscr[] =
{
    ...
    0x00,0xd0,0x14,0x48,             /* Min bit rate (bits/s): 2592 x 1944 x 16 x 15.0 = 1209323520 */
    0x00,0xd0,0x14,0x48,             /* Max bit rate (bits/s): Fixed rate so same as Min */
    ...
    /* Class specific VS Frame Descriptor - YUY2 Format, frameIndex - 2 , Resolution2 1920 x 1080 @ 30.0 fps*/
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype:  frame interface*/
    ...
    0x00,0x80,0x53,0x3b,             /* Min bit rate (bits/s): 1920 x 1080 x 16 x 30.0 = 995328000 */
    ...
    0x15,0x16,0x05,0x00,             /* Default frame interval (in 100ns units): (1/ 30.0)x10^7 */
    0x01,                               /* Frame interval type : No of discrete intervals */
    0x15,0x16,0x05,0x00,             /* Frame interval 3: Same as Default frame interval */
   
    /* Class specific VS Frame Descriptor - YUY2 Format, frameIndex - 3 , Resolution3 1280 x 720 @ 30.0 fps*/
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype:  frame interface*/
    ...
    0x00,0x00,0x5e,0x1a,             /* Min bit rate (bits/s): 1280 x 720 x 16 x 30.0 = 442368000 */
    ...
    /* Class specific VS Frame Descriptor - YUY2 Format, frameIndex - 4 , Resolution4 640 x 480 @ 30.0 fps*/
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype:  frame interface*/
    ...
    0x00,0x00,0xca,0x08,             /* Min bit rate (bits/s): 640 x 480 x 16 x 30.0 = 147456000 */
...
const uint8_t CyCx3USBHSConfigDscr[] =
{
    ...
    0x09,                               /* Descriptor size */
    CY_U3P_USB_CONFIG_DESCR,            /* Configuration descriptor type */
    HS_TOTAL_SIZE_CONFIG_DSCR_L,
    HS_TOTAL_SIZE_CONFIG_DSCR_H,        /* Length of this descriptor and all sub descriptors */
    0x02,                               /* Number of interfaces */
    0x01,                               /* Configuration number */
    ...
    /* Class specific Uncompressed VS Frame Descriptor 4 - Resolution4 640 x 480 @ 30.0 fps*/
    0x1E,                               /* Descriptor size */
    CX3_CS_INTRFC_DESCR,                /* Descriptor type*/
    0x05,                               /* Subtype:  frame interface*/
    0x01,                               /* Frame Descriptor Index: 1 */
...
/* UVC Probe Control Settings -  Input format: YUY2, Output Format: YUY2 - Resolution1 2592 x 1944 @ 15.0 fps*/
uint8_t const glYUY2_YUY2Resolution1ProbeCtrl[CX3_UVC_MAX_PROBE_SETTING] = {
    0x00, 0x00,                           /* bmHint : No fixed parameters */
...
/* UVC Probe Control Settings -  Input format: YUY2, Output Format: YUY2 - Resolution2 1920 x 1080 @ 30.0 fps*/
uint8_t const glYUY2_YUY2Resolution2ProbeCtrl[CX3_UVC_MAX_PROBE_SETTING] = {
    0x00, 0x00,                           /* bmHint : No fixed parameters */
    SS_YUY2_INDEX,                        /* Use 1st Video format index */
    0x02,                               /* Use 1st Video frame index */
    0x15,0x16,0x05,0x00,             /* Desired frame interval in 100ns = (1/ 30.0)x10^7 */
    0x00, 0x00,                           /* Key frame rate in key frame/video frame units */
    0x00, 0x00,                           /* PFrame rate in PFrame / key frame units */
    0x00, 0x00,                           /* Compression quality control */
    0x00, 0x00,                           /* Window size for average bit rate */
...
/* UVC Probe Control Settings -  Input format: YUY2, Output Format: YUY2 - Resolution3 1280 x 720 @ 30.0 fps*/
uint8_t const glYUY2_YUY2Resolution3ProbeCtrl[CX3_UVC_MAX_PROBE_SETTING] = {
    0x00, 0x00,                           /* bmHint : No fixed parameters */
    SS_YUY2_INDEX,                        /* Use 1st Video format index */
    ...
    0x00, 0x00,                           /* Window size for average bit rate */
    0x00, 0x00,                           /* Internal video streaming i/f latency in ms */
    0x00,0x20,0x1c,0x00,             /* Max video frame size in bytes = 1280 x 720 x 2 */ 
#ifdef CX3_UVC_1_0_SUPPORT 
    0x00, 0x90, 0x00, 0x00                /* No. of bytes device can rx in single payload: 36KB */
#else
    /* UVC 1.1 Probe Control has additional fields from UVC 1.0 */
...
/* UVC Probe Control Settings -  Input format: YUY2, Output Format: YUY2 - Resolution4 640 x 480 @ 30.0 fps*/
uint8_t const glYUY2_YUY2Resolution4ProbeCtrl[CX3_UVC_MAX_PROBE_SETTING] = {
    0x00, 0x00,                           /* bmHint : No fixed parameters */
    SS_YUY2_INDEX,                        /* Use 1st Video format index */
...
/* UVC Probe Control Setting - Input format: YUY2, Output Format: YUY2Resolution4 640 x 480 @ 30.0 fps*/
uint8_t const glYUY2_YUY2Resolution4ProbeCtrl_HS[CX3_UVC_MAX_PROBE_SETTING] = {
    0x00, 0x00,                         /* bmHint : No fixed parameters */
